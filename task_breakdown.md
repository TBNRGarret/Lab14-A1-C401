...
- Gọi OpenAI/Gemini API thật để sinh QA pairs từ tài liệu
...
1. **Multi-Judge consensus** chiếm 15đ — nên đầu tư nhiều nhất: Cohen's Kappa, conflict resolution, position bias
2. **Golden Dataset 50+ cases** với Red Teaming — đảm bảo đa dạng difficulty levels

### Ưu tiên trung bình

1. **Async < 2 phút** + Cost report chi tiết
2. **Regression Gate** tự động với logic rõ ràng
3. **5 Whys analysis** sâu, chỉ root cause cụ thể
